...
// Constants
static int ROCK = 1;                        // Rock
static int PAPER = 2;                       // Paper
static int SCISSORS = 3;                    //Scissors

static int COMPUTER = 1;                    //  winner Computer
static int PLAYER = 2;                      // winner PLAYER
static int TIE = 3;                         // TIE

static int GAMENUM = 10;                    // first to win 10 rounds wins game
static int MINCHOICE = 1;                   // min choice for random function
static int MAXCHOICE = 3;                   // max choice for random function
